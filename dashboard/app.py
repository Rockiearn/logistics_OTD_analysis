...
with st.sidebar:
    ...
    * **Tech Stack:** Python, MySQL, Docker
    ...
    st.markdown("---")
    note = os.environ.get("note", "❤️ from Creator Duc Thuan: I'm truly grateful for your time spent to look into my personal project. Happy Learning and Have a good day!")
    st.info(note)
